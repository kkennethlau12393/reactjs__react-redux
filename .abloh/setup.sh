...
# step 1: put the package manager on PATH, for your own lifecycle scripts. From yarn.lock, yarn@4.4.1
corepack enable

# step 2: dependencies, from your lockfile. From yarn.lock, yarn@4.4.1
corepack yarn install --immutable

# step 3: your build. From set by you at the prompt
corepack enable

# step 4: your build. From set by you at the prompt
corepack yarn install --immutable
